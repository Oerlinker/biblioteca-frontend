                ...
                <div className="container mx-auto flex flex-wrap justify-between items-center">
                    ...
                    <nav className="flex flex-wrap items-center space-x-6 mt-4 sm:mt-0">
                        {isLoggedIn ? (
                            <>
                                <span
                                    className="text-lg font-semibold text-white">Bienvenido, {user.nombre || ''}</span>
                                <Link to="/account" className="text-white font-medium hover:underline">Gestionar
                                    Cuenta</Link>
                                {user?.rol === 4 && (
                                    <Link to="/admin"
                                          className="text-white font-medium hover:underline">Administrar</Link>
                                )}
                                {user?.rol === 1 && (
                                    <Link to="/subscription"
                                          className="text-white font-medium hover:underline">Suscripción</Link>
                                )}
                            ...
                            <>
                                <Link to="/login" className="text-white font-medium hover:underline">Iniciar
                                    Sesión</Link>
                                <Link to="/register" className="text-white font-medium hover:underline">Crear
                                    Cuenta</Link>
                                <Link to="/" className="text-white font-medium hover:underline ml-auto">Home</Link>
                                <Link to="/books" className="text-white font-medium hover:underline">Books</Link>
                            </>
